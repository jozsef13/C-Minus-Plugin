...
public class CMinusMulOperationImpl extends ASTWrapperPsiElement implements CMinusMulOperation {

  public CMinusMulOperationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CMinusVisitor visitor) {
    visitor.visitMulOperation(this);
  }
