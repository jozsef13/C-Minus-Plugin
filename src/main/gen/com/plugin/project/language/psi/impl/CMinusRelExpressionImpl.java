...
public class CMinusRelExpressionImpl extends ASTWrapperPsiElement implements CMinusRelExpression {

  public CMinusRelExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CMinusRelExpression getRelExpression() {
    return findChildByClass(CMinusRelExpression.class);
  }

  @Override
  @NotNull
  public CMinusSimpleExpression getSimpleExpression() {
    return findNotNullChildByClass(CMinusSimpleExpression.class);
  }
