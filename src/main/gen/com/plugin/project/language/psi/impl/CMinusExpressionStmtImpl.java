...
public class CMinusExpressionStmtImpl extends ASTWrapperPsiElement implements CMinusExpressionStmt {

  public CMinusExpressionStmtImpl(@NotNull ASTNode node) {
    super(node);
  }
