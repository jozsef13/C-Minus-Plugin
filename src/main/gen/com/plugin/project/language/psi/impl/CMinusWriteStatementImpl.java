...
public class CMinusWriteStatementImpl extends ASTWrapperPsiElement implements CMinusWriteStatement {

  public CMinusWriteStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
