...
public class CMinusSelectionStmtImpl extends ASTWrapperPsiElement implements CMinusSelectionStmt {

  public CMinusSelectionStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CMinusVisitor visitor) {
    visitor.visitSelectionStmt(this);
  }
  ...
  @Override
  @NotNull
  public List<CMinusStatement> getStatementList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CMinusStatement.class);
  }
