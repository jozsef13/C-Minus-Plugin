...
public class CMinusReadStatementImpl extends ASTWrapperPsiElement implements CMinusReadStatement {

  public CMinusReadStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CMinusVar getVar() {
    return findNotNullChildByClass(CMinusVar.class);
  }
