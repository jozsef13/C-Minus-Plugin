...
public class CMinusDeclarationListImpl extends ASTWrapperPsiElement implements CMinusDeclarationList {

  public CMinusDeclarationListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public CMinusDeclaration getDeclaration() {
    return findNotNullChildByClass(CMinusDeclaration.class);
  }
